...
static t_parser	*helper_function3(t_parser *start, t_helper_parser *help, char *str)
{
	if (str[help->i] == '<' && help->count_1 % 2 == 0)
	{
...
static t_parser	*helper_function2(t_parser *start, t_helper_parser *help, char *str)
{
	if (str[help->i] == ';' && help->count_1 % 2 == 0)
	{
		ft_lstadd_back_parser2(&start, ft_lstnew_parser2(ft_strdup(" "), -1, 0));
...
static t_parser	*helper_function1(t_parser *start, t_helper_parser *help, char *str)
{
	if (str[help->i] == '\\')
